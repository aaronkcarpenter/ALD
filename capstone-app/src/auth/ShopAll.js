        ...
        <div className='shop-all-container'>
          ...
          <div className='clothing-container'>
            <div className='products-collection grid-products grid-products--three'>
              <a href='https://www.aimeleondore.com/products/logo-hoodie-2' className='product-pic'>
                <div className='product-image square-image'>
                  <img src='https://cdn.shopify.com/s/files/1/0302/7829/products/tops-3-14_af8824e3-f911-4f84-b0b7-c6c19c09d8da_800x.jpg?v=1599677036' />
                </div>
